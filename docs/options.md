...
Experiments are `experiment-layer.`-prefixed options that split subjects into weighted arms with mutual exclusion via layers. See [Experiments](./experiments.md).
