...
def experiment_property() -> dict[str, str]: ...
"""
Return the value a namespace schema pairs with each ``experiment.<name>`` key,
i.e. ``{"$ref": "#/definitions/Experiment"}``, for assembling a schema in memory.
"""
...
def experiments(namespace: str) -> ExperimentChecker: ...
"""Create an ExperimentChecker for a given options namespace"""
...
class Assignment:
    ...
    status: str
    arm: str | None
    config: dict[str, OptionValue] | None
    excluded_by: str | None
    reason: str | None
    def is_assigned(self) -> bool: ...
    def in_arm(self, arm: str) -> bool: ...
    def to_dict(self) -> dict[str, OptionValue | None]: ...
    def __repr__(self) -> str: ...


class ExperimentChecker:
    def assign(self, experiment: str, context: dict[str, OptionValue]) -> Assignment: ...
    def try_assign(self, experiment: str, context: dict[str, OptionValue]) -> Assignment: ...
    def layer(self, layer: str) -> list[dict[str, OptionValue]]: ...
    def __repr__(self) -> str: ...
...
class ExperimentError(OptionsError): ...
...
def _validate_experiments(namespace: str) -> None: ...
